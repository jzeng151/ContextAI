...
- [ ] Before baseline, the pilot registry freezes opaque rep IDs, cohort, matching strata, and active dates; when each index evaluation is created, orchestration records its CRM owner snapshot, and meeting events later reconcile to that snapshot.
